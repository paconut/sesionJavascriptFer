 ...
 * 
 */
function average(cal1, cal2, cal3, cal4) {
 ...
 */
function divisibilidadSieteOcho(numPrueba) {
    if (numPrueba % 7 == 0 && numPrueba % 8 == 0) {
        console.log("El número es divisible");
    } else if (numPrueba % 7 == 0) {
        console.log("El número solo es divisible entre 7")
    } else if (numPrueba % 8 == 0) {
        console.log("El número solo es divisible entre 8");
    } else {
        console.log("El número no es divisible entre ningún número");
    }
}

divisibilidadSieteOcho(56);
divisibilidadSieteOcho(8);
divisibilidadSieteOcho(7);
divisibilidadSieteOcho(0);
divisibilidadSieteOcho(224);
divisibilidadSieteOcho(73);
/** Ejercicio 5
 * 
 * Desarrolla un programa que evalue si un numero es divisible
 * entre 4 o 9
 ...
 */
function divisibilidadSieteOcho(numPrueba) {
    if (numPrueba % 4 == 0 | numPrueba % 9 == 0) {
        console.log("El número es divisible");
    } else if (numPrueba % 7 == 0) {
        console.log("El número solo es divisible entre 7")
    } else if (numPrueba % 8 == 0) {
...
function calculadora(operacion, num1, num2) {
    ...
    switch (operacion) {
        ...
        case "division":
            ...
            break;
        default:
            console.log("No se hacer esa operación");
            break;
    }
}
/** Ejercicio 7
...
function recomendacion(categoria) {
    ...
    switch (categoria) {
        case "accion":
            console.log("Te recomendamos Noche sin Paz");
            break;
        case "drama":
            console.log("Te recomendamos Los juegos del Hambra balada de pájaros cantores y serpientes");
            break;
        case "comedia":
            console.log("Te recomendamos Renfield");
            break;
        case "romance":
            console.log("Te recomendamos Love Rosie");
            break;
        case "suspenso":
            console.log("Te recomendamos Tenet");
            break;
        case "terror":
            console.log("Te recomendamos El exorcista");
            break;
        default:
            console.log("No conozco ese género");
            break;
    }
}
/** Ejercicio 8
 ...
 * 
 */
function conversorMoneda(cantidad, moneda) {
    moneda = moneda.toUpperCase();
    moneda = moneda.toLowerCase();
    switch (moneda) {
        case "dolar":
            console.log(cantidad * 0.59);
            break;
        case "euro":
            console.log(cantidad * 0.54);
            break;
        case "yen":
            console.log(cantidad * 8.56);
            break;
        case "libra":
            console.log(cantidad * 0.47);
            break;
        case "franco":
            console.log(cantidad * 0.50);
            break;
        default:
            console.log("No conozco esa moneda");
            break;
    }
}
/** Ejercicio 10
 ...
 * 
 */
function descuento(precio, codigoDescuento) {
